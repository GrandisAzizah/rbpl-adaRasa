...
<body>
    <div>
        <div style="display: flex; align-items: center; justify-content: center; position: relative;" class="mb-3">
            ...
            <h5 style="margin: 0;">Tambah Data</h5>
        </div>
        <div class="container">
            <form action="" method="POST" enctype="multipart/form-data">
                ...
                <input type="text" name="nama-menu" id="nama-menu" maxlength="20" required><br><br>
        ...
        <?php if ($pesan): ?>
            <div class="mt-3 alert alert- <?= $tipe ?> alert-dismissible fade show" role="alert">
                <?= $pesan ?>
